...
object ItemType {
  ...
  def loadItemTypes(): Unit = {
    ...
    val itemType2 = new ItemType(
      "ringmailGreaves",
      "Ringmail Greaves",
      "-",
      Assets.getItemIcon(3, 8),
      "boots",
      50,
      null.asInstanceOf[Float],
      7f,
    ...
    val itemType3 = new ItemType(
      "hideGloves",
      "Hide Gloves",
      "-",
      Assets.getItemIcon(0, 8),
      "gloves",
      70,
      null.asInstanceOf[Float],
      5f,
    ...
    val itemType4 = new ItemType(
      "crossbow",
      "Crossbow",
      "-",
      Assets.getItemIcon(4, 6),
      "weapon",
      500,
      45f,
      null.asInstanceOf[Float],
    ...
    val itemType5 = new ItemType(
      "ironSword",
      "Iron Sword",
      "-",
      Assets.getItemIcon(2, 5),
      "weapon",
      100,
      60f,
      null.asInstanceOf[Float],
    ...
    val itemType6 = new ItemType(
      "woodenSword",
      "Wooden Sword",
      "-",
      Assets.getItemIcon(0, 5),
      "weapon",
      70,
      45f,
      null.asInstanceOf[Float],
    ...
    val itemType7 = new ItemType(
      "leatherHelmet",
      "Leather Helmet",
      "-",
      Assets.getItemIcon(2, 7),
      "helmet",
      80,
      null.asInstanceOf[Float],
      9f,
    ...
    val itemType8 = new ItemType(
      "lifeRing",
      "Life Ring",
      "Increases life when worn",
      Assets.getItemIcon(5, 8),
      "ring",
      1000,
      null.asInstanceOf[Float],
      null.asInstanceOf[Float],
    ...
    val itemType9 = new ItemType(
      "poisonDagger",
      "Poison Dagger",
      "-",
      Assets.getItemIcon(6, 5),
      "weapon",
      500,
      40f,
      null.asInstanceOf[Float],
    ...
    val itemType10 = new ItemType(
      "healingPowder",
      "Healing Powder",
      "Quickly regenerates health",
      Assets.getItemIcon(5, 20),
      null,
      45,
      null.asInstanceOf[Float],
      null.asInstanceOf[Float],
    ...
    val itemType11 = new ItemType(
      "trident",
      "Trident",
      "-",
      Assets.getItemIcon(8, 5),
      "weapon",
      900,
      85f,
      null.asInstanceOf[Float],
    ...
    val itemType12 = new ItemType(
      "steelArmor",
      "Steel Armor",
      "-",
      Assets.getItemIcon(4, 7),
      "body",
      200,
      null.asInstanceOf[Float],
      20f,
    ...
    val itemType14 = new ItemType(
      "steelGloves",
      "Steel Gloves",
      "-",
      Assets.getItemIcon(1, 8),
      "gloves",
      130,
      null.asInstanceOf[Float],
      10f,
    ...
    val itemType15 = new ItemType(
      "steelHelmet",
      "Steel Helmet",
      "-",
      Assets.getItemIcon(1, 7),
      "helmet",
      170,
      null.asInstanceOf[Float],
      15f,
